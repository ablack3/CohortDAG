...
test_that("EndStrategy DateOffset generates strategy SQL", {
  ...
  sql <- CohortDAG:::buildCohortQuery(as.character(json))
...
test_that("generate_stats adds inclusion analysis SQL", {
  ...
  result <- CohortDAG:::build_cohort_query_internal(expr, list(generate_stats = TRUE))
...
test_that("buildCohortQuery accepts JSON string directly", {
  ...
  result <- CohortDAG:::buildCohortQuery(json)
...
test_that("get_domain_concept_col returns correct columns", {
  expect_equal(
    CohortDAG:::get_domain_concept_col(list(ConditionOccurrence = list(CodesetId = 1L))),
    "condition_concept_id"
  )
  expect_equal(
    CohortDAG:::get_domain_concept_col(list(DrugExposure = list(CodesetId = 1L))),
    "drug_concept_id"
  )
  expect_equal(
    CohortDAG:::get_domain_concept_col(list(Measurement = list(CodesetId = 1L))),
...
test_that("cohortExpressionFromJson reads from file", {
  ...
  expr <- CohortDAG:::cohortExpressionFromJson(cohort_files[1])
