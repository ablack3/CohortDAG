...
test_that("get_criteria_sql errors on unknown type", {
  expect_error(CohortDAG:::get_criteria_sql(list(unknown_type = list())), "Unknown")
})
...
test_that("get_domain_concept_col returns correct columns", {
  ...
  expect_equal(CohortDAG:::get_domain_concept_col(list(Observation = list())), "observation_concept_id")
  expect_equal(CohortDAG:::get_domain_concept_col(list(ProcedureOccurrence = list())), "procedure_concept_id")
})
