...
ensure_patterns_loaded <- function(path_to_replacement_patterns) {
  ...
  if (is.null(path_to_replacement_patterns) || path_to_replacement_patterns == "") {
    path_to_replacement_patterns <- system.file("csv", "replacementPatterns.csv", package = "CohortDAG")
  }
...
listSupportedDialects <- function() {
  pathToCsv <- system.file("csv", "supportedDialects.csv", package = "CohortDAG")
...
translate_r <- function(sql,
  ...
  pathToReplacementPatterns <- system.file("csv", "replacementPatterns.csv", package = "CohortDAG")
